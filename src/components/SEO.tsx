...
export const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      'https://facebook.com/streamzone',
      'https://twitter.com/streamzone',
      'https://instagram.com/streamzone',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer support',
      email: 'contact@streamzone.buzz'
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:site" content="@streamzone" />
      <meta name="twitter:creator" content="@streamzone" />
      ...
      {publishedAt && <meta property="article:author" content="StreamZone" />}
